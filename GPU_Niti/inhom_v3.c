...
void Set_rot(double rott[V][3][3]);
...
voigt E_oo={-0.00417,-0.00417,-0.0257,0,0,0};
voigt strain[V];
double rot[V][3][3];
double te_p[V][3][3];
voigt te_p2[V];
...
c12=c13=Cijklb*f;
c44=Cijklc*f;
      Cijkl0[0][0][0][0] =c11;	Cijkl1[0][0][0][0] =c11;
      Cijkl0[1][1][1][1] =c11;	Cijkl1[1][1][1][1] =c11;
      Cijkl0[2][2][2][2] =c33;	Cijkl1[2][2][2][2] =c33;
      Cijkl0[0][0][1][1] =c12;	Cijkl1[0][0][1][1] =c12;
      Cijkl0[1][1][2][2] =c13;	Cijkl1[1][1][2][2] =c13;
      Cijkl0[2][2][0][0] =c13;	Cijkl1[2][2][0][0] =c13;
      Cijkl0[0][1][0][1] =c44;	Cijkl1[0][1][0][1] =c44;
      Cijkl0[1][2][1][2] =c44;	Cijkl1[1][2][1][2] =c44;
      Cijkl0[2][0][2][0] =c44;	Cijkl1[2][0][2][0] =c44;
      Cijkl0[1][1][0][0] =c12;	Cijkl1[1][1][0][0] =c12;
      Cijkl0[2][2][1][1] =c13;	Cijkl1[2][2][1][1] =c13;
      Cijkl0[0][0][2][2] =c13;	Cijkl1[0][0][2][2] =c13;
      Cijkl0[1][0][1][0] =c44;	Cijkl1[1][0][1][0] =c44;
      Cijkl0[0][1][1][0] =c44;	Cijkl1[0][1][1][0] =c44;
      Cijkl0[1][0][0][1] =c44;	Cijkl1[1][0][0][1] =c44;
      Cijkl0[2][1][2][1] =c44;	Cijkl1[2][1][2][1] =c44;
      Cijkl0[2][1][1][2] =c44;	Cijkl1[2][1][1][2] =c44;
      Cijkl0[1][2][2][1] =c44;	Cijkl1[1][2][2][1] =c44;
      Cijkl0[0][2][0][2] =c44;	Cijkl1[0][2][0][2] =c44;
      Cijkl0[0][2][2][0] =c44;	Cijkl1[0][2][2][0] =c44;
      Cijkl0[2][0][0][2] =c44;	Cijkl1[2][0][0][2] =c44;
...
#pragma acc enter data copyin(Cij2,E_oo,te_p2,te_p)
	CalcGAMMA(Cijkl0, GAMMA);	// calculate Green operator in k-space
#pragma acc data present(vEps,E_oo,te_p2,eta_r)
#pragma acc parallel loop collapse(3)
	...
	for(int i=0;i<V;i++)
	{
            vEps[pIDX][mi] += eta_r[i][px][py][pz]*te_p2[i][mi];       // Initial guess of virtual strain field
	}
	}}

#pragma acc enter data create(T_tr)
#pragma acc data present(T_tr,te_p2,eta_r)
#pragma acc parallel loop collapse(3) 
	x_loop{ 
	V6_loop{
           // vEps[pIDX][mi] = heta_r[pxyz]*E_oo[mi];       // Initial guess of virtual strain field
	...
	for(int i=0;i<V;i++)
	{
            T_tr[pIDX][mi] += eta_r[i][px][py][pz]*te_p2[i][mi];       // Initial guess of virtual strain field
	}
	}
}
}//end of inhom_init()
...
#pragma acc data present(te_p2,eta_r,T_tr)
#pragma acc parallel loop collapse(3) 
	x_loop{ 
	V6_loop{
        T_tr[pIDX][mi]=0;
	for(int i=0;i<V;i++)
	{
            T_tr[pIDX][mi] += eta_r[i][px][py][pz]*te_p2[i][mi];       // update transformation strain
	}
	}
}
...
#pragma acc data present(Tau,Sij0,Cij0,Cij2,heta_r,E_oo,eta_r,T_tr)
...
chg_basis_Kelvin_1(E_oo,te_p_temp);
...
te_p[i][mi][mj]=0.0;
   T2p_loop{
   te_p[i][mi][mj]+=te_p_temp[mip][mjp]*rott[i][mi][mip]*rott[i][mj][mjp];
   }
 temp[mi][mj]=te_p[i][mi][mj];
}
chg_basis_Kelvin_2(temp,temp_k);
V6_loop{
te_p2[i][mi]=temp_k[mi];
printf("SFTS_v%d_%d=%lf\n",i+1,mi+1,te_p2[i][mi]);
}
}
/*
T2_loop{
te_p_temp[mi][mj]=te_p[mi][mj];
printf("S_%d_%d=%lf\n",mi+1,mj+1,te_p_temp[mi][mj]);
}
chg_basis_Kelvin_2(te_p,te_pk);
*/
/*
C4_loop{
